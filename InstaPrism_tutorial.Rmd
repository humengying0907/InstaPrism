...
Note that to run deconvolution with the updated reference, users need to have BayesPrism installed. We also need to specif the `key` parameter to denote how to update reference. 
